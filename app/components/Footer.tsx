...
function Footer() {
  return (
    <section id="footer">
      <div className="h-screen bg-[url('/images/gallery/bigGird.JPG')] bg-cover bg-[47.5%] bg-no-repeat flex items-end">
        <div className="relative">
          ...
          <div className="flex flex-col items-center text-center gap-4 text-white p-6 z-10 relative">
            ...
            <RevealWrapper duration={1500} origin="bottom">
              <h1 className="text-[1.75rem] font-light">Aulia & Renaldi</h1>
            </RevealWrapper>
          </div>
        </div>
      </div>
